...
function Logo() {
  // stateless component
  // component yang tidak mempunyai state,
  // bisa juga component yang tidak mempunyai state tetapi menerima props untuk menampilkan data / konten
  return (
    <div className="logo">
      <span role="img">🍥</span>
      <h1>WeeBoo</h1>
...
function Search({ children }) {
  // stateful component
  // component yang mempunyai state dan bisa direusable untuk halaman/page lain
  const [query, setQuery] = useState(""); // contoh state
...
function Main({ children }) {
  ...
  // component yang memiliki component lain atau digambungkan ke dalam 1 component
...
function Anime({ anime, onSelectedAnime }) {
  // parameter di kiri berisi state
  // stateless component
  // component yang tidak mempunyai state,
  // bisa juga component yang tidak mempunyai state tetapi menerima props untuk menampilkan data / konten
  return (
